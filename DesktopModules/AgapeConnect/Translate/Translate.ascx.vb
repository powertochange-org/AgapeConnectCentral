    ...
    Partial Class Translate
        ...
        Protected Sub lbModules_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles lbModules.SelectedIndexChanged
            ...
            If lbModules.SelectedIndex >= 0 Then
                ...
                If lbModules.SelectedValue = "StaffRmb (Expense Types)" Then
                    ResxFiles = ResxFiles.Where(Function(x) x.Name.StartsWith("Ctrl") Or x.Name.StartsWith("CIDA"))
                ElseIf lbModules.SelectedValue = "StaffRmb" Then
                    ResxFiles = ResxFiles.Where(Function(x) (Not (x.Name.StartsWith("Ctrl") Or x.Name.StartsWith("CIDA"))) Or x.Name.StartsWith("RmbSettings") Or x.Name.StartsWith("RmbPrintout")).OrderByDescending(Function(x) x.Name.StartsWith(lbModules.SelectedValue & ".")).ThenBy(Function(x) x.Name)
                Else
