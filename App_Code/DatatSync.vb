                ...
                If GetSetting("Nagape", portal.PortalId) = "ON" Then
                    ...
                    For Each adv In portal.Group
                        ...
                        Try
                            ...
                            If diff >= rem3 Then 'And (Not adv.SpareField5 Is Nothing) And CInt(adv.SpareField5) = 2 Then
                                rtn &= "Sending Give-Up  " & vbNewLine
                                SendReminderAdv(adv, diff, GiveUp, AuthUser, AuthAuthUser, portal.PortalId, True, RmbSettings("LargeTransaction"))
                                'adv.SpareField5 = 9

                            ElseIf diff >= rem2 Then 'And (Not adv.SpareField5 Is Nothing) And CInt(adv.SpareField5) = 1 Then
                                ...
                                'adv.SpareField5 = 2
                            ElseIf diff >= rem1 Then 'And adv.SpareField5 Is Nothing Then
